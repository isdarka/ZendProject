	      	...
	      	<div class="modal-body">
	        	<form class="form-horizontal validate" method="post" id="sendMessageForm" action="{$baseUrl}">
	        		<div class="form-group">
						...
						<div class="col-sm-10">
							{html_options options=$messageUsers->toCombo() style="width:100%" name="messageUsers" data-async="/core/user/search" id="messageUsers" class="chosen form-control" multiple="multiple"}
						</div>
					</div>
	        		<div class="form-group">
